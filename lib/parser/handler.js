...
class Handler {
  constructor(options) {
    ...
    this._options.handleObject = this._options.handleObject || ob=>this._handleObject(ob);
  }
  ...
  check(element, item) {
    ...
    //Check if element is a Object
      ...
      var resultObject = this._options.handleObject(element, item, () => this._handleObject.apply(this, arguments));
